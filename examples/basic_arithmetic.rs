...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Result: {} (Expected: 90)", if success { "✓ Correct" } else { "✗ Failed" });
            println!();
        }
        Err(e) => println!("Error: {}\n", e),
    }
...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Division and modulo check: {}", if success { "✓ Both correct (100/7=14, 100%7=2)" } else { "✗ Failed" });
            println!();
        }
        Err(e) => println!("Error: {}\n", e),
    }
...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Is 75 in range (50, 100)? {}", if success { "✓ Yes" } else { "✗ No" });
            println!();
        }
        Err(e) => println!("Error: {}\n", e),
    }
...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Bitwise operations verified: {}", if success { "✓ All correct" } else { "✗ Failed" });
...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Power operations verified: {}", if success { "✓ Correct" } else { "✗ Failed" });
...
"#;
    ...
    match execute_teal_signature(teal_code) {
        Ok(success) => {
            println!("Min operation result: {}", if success { "✓ Correct: min(42, 17) = 17" } else { "✗ Failed" });
