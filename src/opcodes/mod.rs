...
pub const OP_BURY: u8 = 0x4c;
pub const OP_COVER: u8 = 0x4d;
pub const OP_UNCOVER: u8 = 0x4e;
pub const OP_SWAP: u8 = 0x4f;
pub const OP_SELECT: u8 = 0x50;
pub const OP_CONCAT: u8 = 0x51;
pub const OP_SUBSTRING: u8 = 0x52;
pub const OP_SUBSTRING3: u8 = 0x53;
pub const OP_GETBIT: u8 = 0x54;
pub const OP_SETBIT: u8 = 0x55;
pub const OP_GETBYTE: u8 = 0x56;
pub const OP_SETBYTE: u8 = 0x57;
pub const OP_EXTRACT: u8 = 0x58;
pub const OP_EXTRACT3: u8 = 0x59;
pub const OP_EXTRACT_UINT16: u8 = 0x5a;
pub const OP_EXTRACT_UINT32: u8 = 0x5b;
pub const OP_EXTRACT_UINT64: u8 = 0x5c;
pub const OP_REPLACE2: u8 = 0x5d;
pub const OP_REPLACE3: u8 = 0x5e;
pub const OP_BASE64_DECODE: u8 = 0x5f;
pub const OP_JSON_REF: u8 = 0x60;
pub const OP_BALANCE: u8 = 0x70;
pub const OP_APP_OPTED_IN: u8 = 0x71;
pub const OP_APP_LOCAL_GET: u8 = 0x72;
pub const OP_APP_LOCAL_GET_EX: u8 = 0x73;
pub const OP_APP_GLOBAL_GET: u8 = 0x74;
pub const OP_APP_GLOBAL_GET_EX: u8 = 0x75;
pub const OP_APP_LOCAL_PUT: u8 = 0x76;
pub const OP_APP_GLOBAL_PUT: u8 = 0x77;
pub const OP_APP_LOCAL_DEL: u8 = 0x78;
pub const OP_APP_GLOBAL_DEL: u8 = 0x79;
pub const OP_ASSET_HOLDING_GET: u8 = 0x7a;
pub const OP_ASSET_PARAMS_GET: u8 = 0x7b;
pub const OP_APP_PARAMS_GET: u8 = 0x7c;
pub const OP_ACCT_PARAMS_GET: u8 = 0x7d;
pub const OP_MIN_BALANCE: u8 = 0x80;
pub const OP_PUSHBYTES: u8 = 0x81;
pub const OP_PUSHINT: u8 = 0x82;
pub const OP_PUSHBYTESS: u8 = 0x83;
pub const OP_PUSHINTS: u8 = 0x84;
...
pub const OP_SWITCH: u8 = 0xd2;
pub const OP_MATCH: u8 = 0xd3;
pub const OP_FRAME_DIG: u8 = 0xd4;
pub const OP_FRAME_BURY: u8 = 0xd5;
pub const OP_PROTO: u8 = 0xd6;
pub const OP_DUPN: u8 = 0xd7;
pub const OP_POPN: u8 = 0xd8;
